...
void City::display_grid() {
    ...
    if(police[0].getX() == police[1].getX() && police[0].getY() == police[1].getY()){
      city_grid[police[0].getX()][police[0].getY()] = 'P';
    } else{
      city_grid[police[0].getX()][police[0].getY()] = 'p';
      city_grid[police[1].getX()][police[1].getY()] = 'p';
    }
	}
...
bool City::turn() {
	...
	direction[0] = robbers[0].moveRobber(); // normal robbers
	...
	direction[1] = robbers[1].moveRobber();
	...
	do {
		robbers[2].moveRobber(); // greedy robbers
		robber_with_police(0); // checks if robber is with the police
	...
	do {
		robbers[3].moveRobber(); // greedy robbers
		robber_with_police(0); // checks if robber is with the police
